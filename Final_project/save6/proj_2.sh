...
echo "passwd has changed to"
echo "passwd has changed to" >> scriptlog.txt
newline
newline
cat passwd >> scriptlog.txt
cat passwd
...
echo "MODIFYING exports" >> scriptlog.txt
newline
cat exports >> scriptlog.txt
cat exports
newline
echo '#input from script' >> exports
echo '/home.itvm25-4b 10.0.0.0/24(rw,sync,no_root_squash,no_subtree_check)' >> exports
newline
echo "Exports has changed to"
echo "Exports has changed to" >> scriptlog.txt
newline
cat exports >> scriptlog.txt
cat exports
newline
echo "Done modifying exports"
echo "Done modifying exports" >> scriptlog.txt
newline
### END MODYFING EXPORTS ##############
### MODIFYING /etc/auto.master ########

echo "MODIFYING auto.master"
echo "MODIFYING auto.master" >> scriptlog.txt
newline
echo "auto.master is changing from this..." >> scriptlog.txt
echo "auto.master is changing from this..."
cat auto.master >> scriptlog.txt
cat auto.master
newline
echo "#input from script" >> auto.master
echo "/home /etc/auto.home" >> auto.master
newline
echo "auto.master has changed to this..." >> scriptlog.txt
echo "auto.master has changed to this..."
newline
cat auto.master >> scriptlog.txt
cat auto.master
newline
echo "DONE MODIFYING auto.master"
echo "DONE MOFIDYING auto.master" >> scriptlog.txt
newline
